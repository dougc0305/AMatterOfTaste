...
REM =====================================================
REM AMatterOfTaste Build Script
REM =====================================================
REM Builds client (React/Vite) + server (.NET), creates
REM a zip artifact for deployment.
REM =====================================================
...
if not exist "%SOLUTION_DIR%\amatteroftaste-web\package.json" (
  echo ERROR: Could not find client at: "%SOLUTION_DIR%\amatteroftaste-web"
  exit /b 1
)

if not exist "%SOLUTION_DIR%\AMatterOfTaste.Api" (
  echo ERROR: Could not find server at: "%SOLUTION_DIR%\AMatterOfTaste.Api"
  exit /b 1
)
...
set "ZIP_PATH=%OUT_DIR%\AMatterOfTaste_%BRANCH%_%BUILD_ID%.zip"
